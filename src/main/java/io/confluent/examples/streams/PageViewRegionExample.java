 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.1-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.2.1-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }</pre>
