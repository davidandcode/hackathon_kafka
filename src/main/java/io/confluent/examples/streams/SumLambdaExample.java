 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.1-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.2.1-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }</pre>
